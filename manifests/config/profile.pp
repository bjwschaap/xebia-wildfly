...
# variables
  case $profile {
    'standalone-full': {
      ...
      $profile_subsystems = [
        'jboss:domain:logging:3.0',
        'jboss:domain:batch:1.0',
        'jboss:domain:bean-validation:1.0',
        'jboss:domain:datasources:3.0',
        'jboss:domain:deployment-scanner:2.0',
        'jboss:domain:ee:3.0',
        'jboss:domain:ejb3:2.0',
        'jboss:domain:io:1.1',
        'jboss:domain:infinispan:3.0',
        'jboss:domain:jaxrs:1.0',
        'jboss:domain:jca:3.0',
        ...
        'jboss:domain:messaging:3.0',
        'jboss:domain:naming:2.0',
        'jboss:domain:pojo:1.0',
        'jboss:domain:remoting:3.0',
        'jboss:domain:request-controller:1.0',
        'jboss:domain:sar:1.0',
        'jboss:domain:security-manager:1.0',
        'jboss:domain:security:1.2',
        'jboss:domain:transactions:3.0',
        'jboss:domain:undertow:2.0',
        'jboss:domain:webservices:2.0',
